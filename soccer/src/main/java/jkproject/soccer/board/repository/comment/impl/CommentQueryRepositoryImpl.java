package jkproject.soccer.board.repository.comment.impl;

import static jkproject.soccer.board.data.entity.comment.QComment.*;
...
import jkproject.soccer.board.repository.comment.CommentQueryRepository;
